...
// CLEN_BYTES is not really defined on non CHERI.
// On non-CHERI this just means XLEN.
pub const CLEN_BYTES: usize = if cfg!(target_feature = "xcheri") {
    2 * XLEN
} else {
    XLEN
};
...
core::arch::global_asm!(kernel::easm!("
