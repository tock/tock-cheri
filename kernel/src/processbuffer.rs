...
// Allows iterating over WriteableProcessSlice
...
TODO: REFACTOR:
 ...
 I implemented the Slice methods, upstream has added a similar trait to the core one
 Decide which of these is better and commit something
